...
const exampleParameter = new aws.ssm.Parameter("example", {
    type: "String",
    value: "example-value",
});

const eksCluster = new awsEksCluster("eks", {
    awsProvider: awsconfig.awsProvider,
    region: "us-west-2",
...
//     const awsS3BucketAclForBackup = new aws.s3.BucketAclV2(`public-backup`, {
//         bucket: awsS3BucketForBackup.id,
//         acl: "public-read",
//     });
// }

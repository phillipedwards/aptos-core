...
export const numUtilityInstance: pulumi.Input<number> = config.getNumber("numUtilityInstance") || 1;
// Number of instances for validator node pool, when it's 0, it will be set to 2 * var.num_validators
export const numValidatorInstance: pulumi.Input<number> = config.getNumber("numValidatorInstance") || 1;
// Maximum number of instances for utilities. If left 0, defaults to 2 * var.num_validators
export const utilityInstanceMaxNum: pulumi.Input<number> = config.getNumber("utilityInstanceMaxNum") || 1;
// Minimum number of instances for utilities.
export const utilityInstanceMinNum: pulumi.Input<number> = config.getNumber("utilityInstanceMinNum") || 1;
export const utilityInstanceEnableTaint: pulumi.Input<boolean> = config.getBoolean("utilityInstanceEnableTaint") || false;
// Maximum number of instances for utilities. If left 0, defaults to 2 * var.num_validators
export const validatorInstanceMaxNum: pulumi.Input<number> = config.getNumber("validatorInstanceMaxNum") || 1;
